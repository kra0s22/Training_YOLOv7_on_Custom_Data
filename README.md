...
* Training a YOLOv7 model and save up in Google Drive
* Usage of IOU measurement for the evaluation, showing emphasis on object detection.
* Possible solutions for the model's bad performance. (not implemented)
